...
internal object CapabilityRegistryGenerated {
    ...
    val dependencies: List<PublicDependencyRecord> = listOf(
        ...
        PublicDependencyRecord(
            ...
            purpose = "GPL FFmpeg paths not covered by Media3 Transformer",
            publicStatus = "bundled",
        ),
        PublicDependencyRecord(
    ...
    val notices: List<OpenSourceLicenseNotice> = listOf(
        ...
        OpenSourceLicenseNotice(
            ...
            licenseText = "This source-pinned build enables GPL components including x264. Redistribution must preserve the packaged licenses and corresponding-source offer.",
            licenseUrl = "https://www.gnu.org/licenses/gpl-3.0.txt",
            projectUrl = "https://github.com/arthenica/ffmpeg-kit-next",
            sourceOfferText = "Exact corresponding-source recipe for this GPL v3.0 build:\nhttps://github.com/arthenica/ffmpeg-kit-next/tree/3e223118e6e8fb6208693ecf3952e77cd096f587\nCommand: ./nix-android.sh -p android-r27d --enable-gpl --enable-x264 --enable-libass --jobs=8\nThe complete recipe, checksums, enabled components, and source revisions are recorded in third_party/ffmpeg-kit-next/native-lock.json and the installed application resource res/raw/ffmpeg_kit_next_source_offer.txt.",
